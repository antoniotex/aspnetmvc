...
namespace AppMvcBasica.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            // Incluiu tambem info dos fornecedores
        ...
        public IActionResult Create()
        {
            ...
            // Outra opção. ViewBag está dentro da ViewData. Info só dura até chegar na View
            //ViewBag.FornecedorId = new SelectList(_context.Fornecedores, "Id", "Documento");
            // Outra forma de fazer. Dura 1 request, posso transitar entre controllers.
            //É tipo uma session de curta duração.
